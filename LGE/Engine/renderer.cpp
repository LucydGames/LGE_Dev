...
namespace lge
{
	void Renderer::Initialize(SDL_Window* window, bgfx::RendererType::Enum RendererApiType)
	{
		...
		case bgfx::RendererType::Vulkan:
			m_DefaultShaderProgram = new ShaderProgram("../LGE/vertexspirv.bin", "../LGE/fragspirv.bin");
			break;
		case bgfx::RendererType::Direct3D11:
			m_DefaultShaderProgram = new ShaderProgram("../LGE/vertexd3d.bin", "../LGE/fragd3d.bin");
			break;
		...
		//m_DefaultShaderProgram = new ShaderProgram("../LGE/vertex.bin", "../LGE/frag.bin"); //Change path to sdk library default shaders 
	...
	void Renderer::Render()
	{
		...
		for (RenderBatch& batch : m_RenderBatches)
		{
			...
			bgfx::submit(TWO_D_VIEW, m_DefaultShaderProgram->GetProgramHandle(), batch.Depth);
		}
		...
		bgfx::submit(RENDER_VIEW, m_DefaultShaderProgram->GetProgramHandle());
